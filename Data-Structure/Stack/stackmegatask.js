...
const stackTwo = new StackNew();
console.log("====Parctice Stack 2nd Time====");

stackTwo.push("Hammad");
stackTwo.push("Ali Abdullah");
stackTwo.push("Fahad Arshad");

stackTwo.print();

console.log(stackTwo.size()); // 3
console.log(stackTwo.peek()); // Hammad
console.log(stackTwo.isEmpty()); // false
stackTwo.pop();
stackTwo.pop(); 
console.log(stackTwo.size()); 1


//? ab calculater banana 


class CalculatorNew {
    constructor(){
        this.stack = new StackNew();
        this.redoStackNew = StackNew();
        this.currentNew = 0;
    };

    calculateNew(x, operator, y) {
        this.stack.push(this.currentNew);
        ...
        let result = this.currentNew;
        console.log(`Result: ${this.currentNew}`);
    };
};